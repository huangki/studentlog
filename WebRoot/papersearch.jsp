...
<body>
	...
	<TABLE bgcolor=DodgerBlue>
		...
		<%
			//利用while迴圈將資料表中的記錄列出
			String sql = "SELECT * FROM dbo.License  ";
		...
		<TR bgcolor=LightGoldenrodYellow>
			...
			<TD><B><%=rs.getString("LicenseName")%></B></TD>
			<TD><B><%=rs.getString("LicenseAbout")%></B></TD>
			<TD><B><%=rs.getString("LicenseClass")%></B></TD>
		 

			<TD><B> <a href=licensecorrect.jsp?L=<%=rs.getString("LicenseId")%>>修正</a> 
					<a href=licensedelete.jsp?LicenseId=<%=rs.getString("LicenseId")%>>刪除</a> </B></TD>
