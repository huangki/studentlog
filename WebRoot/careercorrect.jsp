...
<h2>證照資料修改</h2>
 <html>
	...
	<%
        ...
        String sql="SELECT * FROM dbo.Career WHERE Cnum='"+A+"'";
...
<h2>	
<FORM method="POST" name="ju" action="careercorrect_w.jsp">
 <input type="hidden" name="Cnum"   value="<%=A%>"><br> 
職業名稱:<input type="text" name="Cname" size=40 value="<%=rs.getString("Cname")%>" ><br> 
工作內容:<input type="text" name="Cabout" size=40 value="<%=rs.getString("Cabout")%>" ><br> 
