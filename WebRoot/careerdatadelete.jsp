...
<body>
	<%
		...
		String LicenseId = request.getParameter("LId");
		...
		ResultSet rs;
		String sql = "SELECT * FROM dbo.CareerData where N='" + LicenseId + "'";
		rs = stmt.executeQuery(sql);

		String sqldel = "delete from dbo.CareerData  where N='" + LicenseId + "'";
		int result = stmt.executeUpdate(sqldel);
		out.print("已刪除該筆資料編碼為" + LicenseId + "的資料");
		rs.close();
		stmt.close();
		con.close();
		}
	...
	%>
	<a href= careerdatasearch.jsp>職涯資料查詢</a>
</body></div>
</html>